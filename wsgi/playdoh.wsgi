...
if newrelic_cfg_file:
    ...
    if newrelic_settings.browser_monitoring.auto_instrument:
        raise Exception('newrelic browser_monitoring.auto_instrument '
                        'must be disabled, or else Thimble projects '
                        'will contain instrumentation code, confusing users')
