...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.creator'
        db.add_column('api_page', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pages', null=True, to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Page.creator'
        db.delete_column('api_page', 'creator_id')
